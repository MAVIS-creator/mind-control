      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="glass-panel text-center rounded-3xl p-6 shadow-xl mb-8">
          ...
          <div className="mt-2 flex items-center justify-center gap-3">
            <span className="font-mono text-4xl font-black tracking-widest text-[#0f172a] dark:text-white">
              {room.roomCode}
            </span>
            <button
        ...
        <div className="grid gap-6 sm:grid-cols-2 mb-8">
          ...
          <div className="glass-panel rounded-3xl p-6 text-center shadow-lg border-2 border-[#2406e2]/20">
            ...
            <h3 className="mt-3 font-display text-lg font-bold text-[#0f172a] dark:text-white">
