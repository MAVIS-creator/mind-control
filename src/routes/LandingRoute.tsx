      ...
      <main className="mx-auto max-w-[1500px] px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        <section className="grid items-center gap-8 lg:grid-cols-[1.25fr_0.75fr]">
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="text-center lg:text-left">
            <div className="flex flex-wrap items-center justify-center gap-2 lg:justify-start">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/80 px-4 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-[#1c05b3] shadow-[0_14px_30px_rgba(28,5,179,0.1)] backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/90 dark:text-white sm:text-xs">
                <SparklesIcon className="h-4 w-4 text-[#1c05b3] dark:text-sky-400" />
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full border border-blue-200/80 bg-blue-50/80 px-3.5 py-1.5 text-[0.68rem] font-bold uppercase tracking-[0.16em] text-[#1c05b3] shadow-sm backdrop-blur-xl transition hover:bg-blue-100 hover:scale-[1.02] dark:border-blue-900/50 dark:bg-blue-950/60 dark:text-sky-300 dark:hover:bg-blue-900/80 sm:text-xs"
              >
            ...
            <h1 className="mt-7 font-display text-[3.4rem] font-extrabold uppercase leading-[0.88] tracking-[-0.08em] text-[#1c05b3] dark:text-white sm:text-[5.5rem] lg:text-[6.7rem]">
              MindGrid
            </h1>
            ...
            <div className="mt-7 flex flex-wrap justify-center gap-3 sm:flex-row lg:justify-start">
              <Link
                to="/register"
                className="inline-flex items-center justify-center gap-3 rounded-full bg-gradient-to-b from-[#2406e2] to-[#1c05b3] px-8 py-4 text-[1.05rem] font-semibold text-white shadow-[0_18px_30px_rgba(28,5,179,0.28)] transition hover:from-[#1c05b3] hover:to-[#120282] hover:scale-[1.01]"
              >
          ...
          <motion.aside
            ...
            className="glass-panel rounded-[2.1rem] p-5 shadow-[0_18px_40px_rgba(28,5,179,0.1)] sm:p-6 dark:border dark:border-slate-800 dark:bg-slate-900/90"
          >
            <div className="flex items-center justify-between border-b border-[#e2e8f0] pb-4 dark:border-slate-800">
              ...
              <Link
                to="/ranks"
                className="rounded-full bg-[#eff1ff] px-4 py-2 text-xs font-semibold text-[#1c05b3] transition hover:bg-[#e0e4ff] dark:bg-slate-800 dark:text-sky-300 dark:hover:bg-slate-700"
              >
                Full Board
              </Link>
            </div>
            ...
            <div className="mt-4 space-y-3">
              {previewRanks.map((rank, index) => {
                ...
                return (
                  <div
                    key={rank.name}
                    className="flex items-center justify-between rounded-2xl border border-white/80 bg-white/76 p-3 shadow-sm transition hover:border-[#9da9ff] dark:border-slate-800 dark:bg-slate-950"
                  >
                    <div className="flex items-center gap-3">
                      <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#eff1ff] text-xs font-bold text-[#1c05b3] dark:bg-slate-800 dark:text-sky-300">
                        {index + 1}
                      </span>
                    ...
                    <span className="font-display text-sm font-bold text-[#1c05b3] dark:text-sky-400">{formatNumber(rank.score)}</span>
                  </div>
                );
              })}
            </div>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 border-t border-[#e2e8f0] pt-4 dark:border-slate-800">
              <div className="rounded-2xl bg-[#f0f9ff] p-3 text-center dark:bg-slate-950">
                ...
                <p className="mt-1 font-display text-xl font-bold text-[#1c05b3] dark:text-sky-400">{formatNumber(bestScore)}</p>
              </div>
              <div className="rounded-2xl bg-[#f0f9ff] p-3 text-center dark:bg-slate-950">
        ...
        <section className="mt-10">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#1c05b3] dark:text-sky-400">How it plays</p>
          ...
          <div className="mt-7 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {gameSteps.map((step) => {
              ...
              return (
                <article key={step.title} className="glass-panel rounded-[1.7rem] p-6 shadow-[0_14px_32px_rgba(28,5,179,0.08)] dark:border dark:border-slate-800 dark:bg-slate-900/90">
                  <div className="flex h-14 w-14 items-center justify-center rounded-[1.3rem] bg-[#eff1ff] text-[#1c05b3] dark:bg-slate-800 dark:text-white shadow-[0_12px_24px_rgba(28,5,179,0.1)]">
        ...
        <section className="mt-10 grid gap-5 lg:grid-cols-2">
          <div className="glass-panel rounded-[2rem] p-6 shadow-[0_14px_32px_rgba(28,5,179,0.08)] sm:p-8 dark:border dark:border-slate-800 dark:bg-slate-900/90">
          ...
          <div className="glass-panel rounded-[2rem] p-6 shadow-[0_14px_32px_rgba(28,5,179,0.08)] sm:p-8 dark:border dark:border-slate-800 dark:bg-slate-900/90">
            ...
            <h2 className="mt-3 text-[2.2rem] font-bold tracking-[-0.05em] text-[#1c05b3] dark:text-sky-300">Best run ranks. Points stack.</h2>
            <p className="mt-4 text-base leading-8 text-[#475569] dark:text-slate-300">
        ...
        <section className="mt-10 glass-panel overflow-hidden rounded-[2.2rem] p-6 sm:p-8 shadow-[0_18px_40px_rgba(28,5,179,0.1)] dark:border dark:border-slate-800 dark:bg-slate-900/90">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row text-center md:text-left">
            <div className="flex flex-col items-center gap-5 md:flex-row">
              ...
              />
              <div>
                <div className="inline-flex items-center gap-2 rounded-full bg-[#eff1ff] px-3 py-1 text-[11px] font-bold uppercase tracking-wider text-[#1c05b3] dark:bg-blue-900/40 dark:text-sky-300 border border-blue-200 dark:border-blue-800">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-[#1c05b3] px-6 py-3.5 text-sm font-bold text-white shadow-md transition hover:bg-[#120282] hover:scale-[1.02] dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 shrink-0"
            >
        ...
        <section className="mt-10 glass-panel rounded-[2.2rem] p-6 text-center shadow-[0_18px_40px_rgba(28,5,179,0.1)] sm:p-10 dark:border dark:border-slate-800 dark:bg-slate-900/90">
          <StarBadgeIcon className="mx-auto h-10 w-10 text-[#1c05b3] dark:text-sky-400" />
          ...
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            <Link to="/register" className="rounded-full bg-gradient-to-b from-[#2406e2] to-[#1c05b3] px-8 py-4 font-semibold text-white shadow-[0_18px_30px_rgba(28,5,179,0.28)] transition hover:from-[#1c05b3] hover:to-[#120282]">
              Create Account
            </Link>
            <Link to="/contact" className="rounded-full border border-[#cbd5e1] bg-white/80 px-8 py-4 font-semibold text-[#1c05b3] dark:border-slate-800 dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800">
              Contact Us
            </Link>
          </div>
        </section>
