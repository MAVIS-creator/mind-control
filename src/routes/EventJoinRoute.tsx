      ...
      <EventEditionShell edition={edition}>
        <main className="flex min-h-[70svh] items-center justify-center px-4 text-center">
          <div className="glass-panel rounded-[2rem] p-8">
            ...
            <p className="mt-4 font-bold text-[#3525cd]">Loading event...</p>
          </div>
        </main>
      </EventEditionShell>
    );
      ...
      <main className="mx-auto max-w-[1440px] px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        <section className="grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="glass-panel rounded-[2.2rem] p-5 shadow-[0_18px_42px_rgba(53,37,205,0.08)] sm:p-7">
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#3525cd]">{edition.config.eventLabel}</p>
            <h2 className="mt-2 text-3xl font-bold tracking-[-0.05em] text-[#111c2d]">Enter Event</h2>
        ...
        <section className="mt-10">
          <div className="mb-5 text-center">
            ...
            <h2 className="mt-2 text-4xl font-bold tracking-[-0.05em] text-[#111c2d]">This event is bigger than one match.</h2>
          </div>
