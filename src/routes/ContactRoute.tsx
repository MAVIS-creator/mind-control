    ...
    <main className="mx-auto flex min-h-[calc(100svh-170px)] max-w-[1280px] flex-col justify-center px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
      <section className="grid items-center gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <p className="mt-5 max-w-2xl text-base leading-8 text-[#475569] dark:text-slate-200 sm:text-lg">
        ...
        <div className="glass-panel rounded-[2.2rem] p-5 shadow-[0_18px_40px_rgba(37,99,235,0.08)] sm:p-7 dark:border dark:border-slate-800 dark:bg-slate-900/90">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#64748b] dark:text-slate-400">Best message format</p>
              <h2 className="text-2xl font-bold tracking-[-0.04em] text-[#0f172a] dark:text-white">What to include</h2>
            </div>
          </div>
          <div className="space-y-3 text-sm leading-7 text-[#475569] dark:text-slate-200">
