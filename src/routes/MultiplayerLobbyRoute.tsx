...
export const MultiplayerLobbyRoute = () => {
  ...
  return (
    <AppShell session={session} active="home">
      ...
      <div className="min-h-full bg-[radial-gradient(circle_at_top_left,_#e0e4ff_0%,_#f8faff_42%,_#dbeafe_100%)] dark:bg-none dark:bg-slate-950 px-3 py-5 pb-32 sm:px-6 sm:py-8 sm:pb-36 md:pb-10">
        <div className="mx-auto max-w-5xl">
          <div className="glass-panel rounded-[2rem] px-4 py-6 shadow-[0_18px_40px_rgba(28, 5, 179,0.08)] sm:rounded-[2.5rem] sm:px-8 sm:py-8 md:px-12">
            
            {/* Top Navigation Toggle: Single Player vs Multiplayer */}
            <div className="mb-8 h-1 rounded-full bg-gradient-to-r from-[#1c05b3] via-[#2406e2] to-[#2406e2]" />

            <div className="mb-8 flex justify-center">
              <div className="inline-flex rounded-full bg-[#eff1ff] dark:bg-slate-900/90 p-1.5 shadow-inner">
                <Link
                  to="/play"
                  className="rounded-full px-6 py-2.5 text-sm font-semibold text-[#475569] dark:text-slate-300 hover:text-[#120282] dark:hover:text-white transition-all"
                >
                  Single Player
                </Link>
                <button
                  type="button"
                  className="rounded-full bg-gradient-to-b from-[#1c05b3] to-[#140494] px-6 py-2.5 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(28, 5, 179,0.24)]"
                >
                  Multiplayer Clash
                </button>
              </div>
            ...
            <div className="mb-8 grid gap-4 sm:grid-cols-3">
              <div
                ...
                className={`cursor-pointer rounded-3xl p-5 transition-all ${
                  selectedMode === "turn_based"
                    ? "bg-white/90 shadow-[0_12px_32px_rgba(28, 5, 179,0.15)] ring-2 ring-[#1c05b3] dark:bg-slate-900 dark:ring-[#2406e2]"
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="rounded-xl bg-[#1c05b3]/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[#1c05b3] dark:bg-[#120282] dark:text-[#2406e2]">
                    1v1 Duel
                  </span>
                </div>
              ...
              <div
                ...
                className={`cursor-pointer rounded-3xl p-5 transition-all ${
                  selectedMode === "speed_sprint"
                    ? "bg-white/90 shadow-[0_12px_32px_rgba(28, 5, 179,0.15)] ring-2 ring-[#120282] dark:bg-slate-900 dark:ring-[#2406e2]"
                    : "bg-white/60 hover:bg-white/80 border border-white/60 dark:bg-slate-900/60 dark:border-slate-800 dark:hover:bg-slate-900"
                }`}
              >
                <div className="flex items-center justify-between">
                  <span className="rounded-xl bg-[#120282]/10 px-3 py-1 text-xs font-bold uppercase tracking-wider text-[#120282] dark:bg-[#120282] dark:text-[#2406e2]">
                    Speed Race
                  </span>
                </div>
            ...
            <div className="grid gap-8 lg:grid-cols-12">
              ...
              <div className="rounded-3xl bg-white/70 dark:bg-slate-900/90 p-6 shadow-md border border-white/80 dark:border-slate-800 lg:col-span-7">
                    ...
                    {(["4x4", "5x6", "6x6"] as GridSize[]).map((size) => (
                      <button
                        ...
                        className={`rounded-2xl py-3 text-xs font-bold transition-all ${
                          selectedGrid === size
                            ? "bg-[#1c05b3] text-white shadow-md"
                ...
                <button
                  ...
                  disabled={isCreating}
                  className="mt-6 w-full rounded-2xl bg-gradient-to-r from-[#1c05b3] via-[#120282] to-[#0369a1] py-4 font-display text-sm font-bold uppercase tracking-wider text-white shadow-[0_8px_24px_rgba(28, 5, 179,0.35)] transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50"
                >
                ...
                <div className="rounded-3xl bg-white/70 dark:bg-slate-900/90 p-6 shadow-md border border-white/80 dark:border-slate-800">
                  ...
                  <form onSubmit={handleJoinByCode} className="mt-4 flex gap-3">
                    <input
                      ...
                      className="w-full rounded-2xl border border-[#e0e4ff] bg-white px-4 py-3 text-center font-mono text-base font-bold uppercase tracking-widest text-[#0f172a] placeholder-[#94a3b8] focus:border-[#1c05b3] focus:outline-none focus:ring-2 focus:ring-[#1c05b3]/30 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:placeholder-slate-500"
                    />
                    <button
                      type="submit"
                      ...
                      openRooms.map((room) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            disabled={isJoining}
                            className="rounded-xl bg-[#1c05b3] px-3 py-1.5 text-[11px] font-bold text-white transition-all hover:bg-[#140494]"
                          >
                            Join Room
                          </button>
                        </div>
