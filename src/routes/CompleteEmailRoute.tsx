  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_#e2dfff_0%,_#f9f9ff_45%,_#d4e3ff_100%)] dark:bg-none dark:bg-slate-950 px-4 py-8 sm:px-6 lg:px-10">
      ...
      <div className="mx-auto flex max-w-5xl items-center justify-center">
        <section className="glass-panel w-full max-w-[34rem] rounded-[2.5rem] px-6 py-8 shadow-[0_26px_60px_rgba(53,37,205,0.08)] sm:px-8 dark:bg-slate-900/90 dark:border dark:border-slate-800">
          <BrandMotionMark className="mx-auto mb-6 w-[11rem] sm:w-[14rem]" />
          <p className="text-center text-xs font-semibold uppercase tracking-[0.3em] text-[#667085] dark:text-slate-400">Complete Account Setup</p>
          <h1 className="mt-3 text-center font-display text-[2.3rem] font-extrabold tracking-[-0.06em] text-[#111c2d] dark:text-white">
            Add your real email
          </h1>
