...
export const ForcePasswordResetModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-md px-4">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-2xl border border-indigo-100 text-center">
        ...
        <h2 className="font-display text-xl font-black text-[#1e1b4b]">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4 text-left">
          <div>
            ...
            <input
              ...
              className="mt-1.5 w-full rounded-xl border border-slate-200 px-4 py-3 text-xs text-[#1e1b4b] focus:border-[#3525cd] focus:outline-none"
            />
          </div>
