export const SiteFooter = () => (
  <footer className="mt-8 shrink-0 border-t border-[#cfe0ff] bg-[linear-gradient(180deg,rgba(244,248,255,0.98),rgba(233,242,255,0.96))] backdrop-blur-xl">
    <div className="mx-auto grid max-w-[1440px] grid-cols-1 items-center gap-4 px-4 py-5 text-center sm:px-6 md:grid-cols-[auto_1fr_auto] md:text-left lg:px-8 xl:px-10">
      ...
      <div className="hidden h-px w-full bg-[linear-gradient(90deg,transparent,#cfe0ff,transparent)] md:block" />
      <p className="text-sm font-medium text-[#5a6790] md:justify-self-end">Built by Klyvex Studios</p>
    </div>
  </footer>
);
