...
export const BetaFounderClaimModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-md overflow-hidden rounded-[2.2rem] border border-amber-300/60 bg-gradient-to-b from-[#1e1b4b] via-[#2e1065] to-[#0f172a] p-7 text-center shadow-[0_25px_60px_rgba(245,158,11,0.25)]">
        {/* Top Glow & Badge */}
        ...
        <div className="mt-5 space-y-2.5 rounded-2xl border border-white/10 bg-white/5 p-4 text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-white">+1,000 Founder XP Boost</p>
              <p className="text-[11px] text-slate-400">Instantly unlocks higher level tiers.</p>
            </div>
          </div>
        </div>
