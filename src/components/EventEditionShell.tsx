...
export const EventEditionShell = ({ children, edition }: { children: ReactNode; edition?: EventEdition | null }) => (
  <div className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,_#eff1ff_0%,_#f8faff_42%,_#eff1ff_100%)] dark:bg-none dark:bg-slate-950 text-[#0f172a] dark:text-slate-200">
      ...
      <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <Link to={edition ? `/${edition.slug}` : "/"} className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[0.65rem] font-bold uppercase tracking-[0.22em] text-[#1c05b3] dark:text-sky-400">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-full border border-[#cbd5e1] dark:border-slate-800 bg-white/80 dark:bg-slate-900 px-4 py-2 text-sm font-semibold text-[#1c05b3] dark:text-sky-400 shadow-sm"
        >
